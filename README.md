...
Reproducing the paper [Deep Autoencoding Gaussian Mixture Model for Unsupervised Anomaly Detection](https://openreview.net/forum?id=BJJLHbb0-). Please Let me know if there are any bugs in my code. Thank you! =)

Implementation on Python 3.6 using PyTorch 0.4.0.

## Acknowledgement 
The base code forked from [danieltan07](https://github.com/danieltan07/dagmm).
